...
本プロジェクトの正本は [01_仕様書.md](01_仕様書.md) です。この入門では、仕様書の構成を崩さずに「なぜその構成にしているのか」「Feature Store Offline では何がうれしいのか」を説明します。
...
1. [01_仕様書.md](01_仕様書.md)
2. [Feature-store入門.md](Feature-store入門.md)
3. [02_実装カタログ.md](02_実装カタログ.md)
4. [03_運用.md](03_運用.md)
